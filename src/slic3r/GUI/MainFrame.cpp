...
{
    if (m_tabpanel->GetPage(tpMonitor) != m_monitor && m_tabpanel->GetPage(tpMonitor) != m_printer_view) {
...
void MainFrame::init_menubar_as_editor()
{
    ...
    if (m_plater) {
        ...
        append_menu_check_item(
            viewMenu, wxID_ANY, _L("Show &G-code Window") + "\tC", _L("Show g-code window in Previce scene"),
            [this](wxCommandEvent&) {
